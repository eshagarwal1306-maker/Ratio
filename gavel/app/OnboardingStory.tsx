...
const STORY_SLIDES = [
  {
    ...
    body: "Legal AI tools hallucinate citations, misapply jurisdiction, cite repealed provisions, and contradict your own firm's prior positions. GAVEL catches all of it — before the memo leaves your inbox.",
    accent: "#4a9eff",
    icon: "⚖",
  ...
  },
  {
    ...
    body: "January 2025. Jack & Jill Capital Partners are preparing for DORA. Their in-house AI generates a compliance memo citing Article 30(3), claiming non-compliance carries 2% global turnover penalties under Article 50. The partner signs off. GAVEL is the last line of defence.",
    accent: "#f5a623",
    icon: "📄",
    tag: "DEMO SCENARIO",
    cta: "What did GAVEL find? →",
  },
  {
    id: "sourcer",
